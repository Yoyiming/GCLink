...
for epoch in range(args.epochs):
    ...
    if AUC > AUC_Threshold:
        AUC_Threshold = AUC
        torch.save(model.state_dict(), model_path + '/' + args.cell_type + '1000_i+e_shared_True' + '.pkl')

model.load_state_dict(torch.load(model_path + '/' + args.cell_type + '1000_i+e_shared_True' + '.pkl'))
model.eval()
...
np.savetxt('Result/Specific/TF+1000/' + args.sample + '_' + args.cell_type + '_i+e_shared_True.txt', np.array([AUC, AUPR]), fmt='%.3f')
...
# pre_data.to_csv("mHSC-E_pre.csv")
