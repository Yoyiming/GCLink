...
model.load_state_dict(torch.load(model_path + '/source_hHEP1000_i+e_False_shared.pkl'))
...
model.load_state_dict(torch.load(model_path + '/' + args.cell_type + '1000_i+e_finetune_shared.pkl'))
...
np.savetxt('AUC_AUPR_Result/Specific/TF+1000/hHEP1000_' + args.sample + '_' + args.cell_type + '_i+e_False_transfer_finetune.txt', np.array([AUC, AUPR]), fmt='%.3f')
