...
if __name__ == '__main__':
    ...
    TF2file = os.getcwd() + '/10k_PBMCs Dataset/TF_list.csv'
    Gene2file = os.getcwd() + '/10k_PBMCs Dataset/Target_list.csv'
    label_file = os.getcwd() + '/10k_PBMCs Dataset/Label.csv'

    for i in range(5):
        # path = os.getcwd() + '/Data/' + net_type + '/' + data_type + ' ' + str(args.num) + '/sample' + str(i+1)
        path = os.getcwd() + '/Data/' + net_type + '/' + 'sample' + str(i + 1)
